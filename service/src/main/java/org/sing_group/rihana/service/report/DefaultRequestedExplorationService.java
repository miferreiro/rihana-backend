...
@Stateless
@PermitAll
public class DefaultRequestedExplorationService implements RequestedExplorationService {

	@Inject
	private RequestedExplorationDAO requestedExplorationDAO;
	...
	public RequestedExploration create(RequestedExploration requestedExploration) {
		...
		return requestedExplorationDAO.create(requestedExploration);
	}
}
