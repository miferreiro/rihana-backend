...
@Stateless
@PermitAll
public class DefaultFunctionalityActionService implements FunctionalityActionService {

	@Inject
	private FunctionalityActionDAO functionalityActionDAO;
	...
	public FunctionalityAction create(FunctionalityAction functionalityAction) {
		...
		if (!this.permissionService.hasPermission(
				loginLogged,
				"FUNCTIONALITY_ACTION_MANAGEMENT",
				"ADD") &&
		...
		return functionalityActionDAO.create(functionalityAction);
	}
	...
	public Stream<FunctionalityAction> getFunctionalityActions() {
		...
		return functionalityActionDAO.getFunctionalityActions();
	}
	...
	public FunctionalityAction get(FunctionalityActionKey id) {
		...
		return functionalityActionDAO.get(id);
	}
	...
	public void delete(FunctionalityAction functionalityAction) {
		...
		functionalityActionDAO.delete(functionalityAction);
	}
}
