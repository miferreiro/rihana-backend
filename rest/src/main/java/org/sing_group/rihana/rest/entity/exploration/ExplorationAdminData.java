...
@XmlRootElement(name = "exploration-admin-data", namespace = "http://entity.resource.rest.rihana.sing-group.org")
@XmlAccessorType(XmlAccessType.FIELD)
@ApiModel(value = "exploration-admin-data", description = "Information of an exploration for admin.")
public class ExplorationAdminData implements Serializable {
