...
@Default
public class DefaultFunctionalityActionMapper implements FunctionalityActionMapper {
	...
	@Override
	public FunctionalityActionData toFunctionalityActionData(FunctionalityAction functionalityAction) {
		return new FunctionalityActionData(
			functionalityAction.getFunctionalityActionKey().getFunctionalityId(),
			functionalityAction.getFunctionalityActionKey().getActionId()
		);
	}
}
