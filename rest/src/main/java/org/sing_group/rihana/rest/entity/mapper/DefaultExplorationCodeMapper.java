...
@Default
public class DefaultExplorationCodeMapper implements ExplorationCodeMapper {
	...
	@Override
	public ExplorationCodeData toExplorationCodeData(ExplorationCode explorationCode) {
		return new ExplorationCodeData(
			explorationCode.getCode(), explorationCode.getDescription()
		);
	}
}
