 ...
 * #L%
 */
package org.sing_group.rihana.rest;
...
public class SwaggerConfiguration implements ReaderListener {
	@Resource(name = "java:global/rihana/swagger/version")
	private String version;
	@Resource(name = "java:global/rihana/swagger/schemes")
	private String schemes;
	@Resource(name = "java:global/rihana/swagger/host")
	private String host;
	@Resource(name = "java:global/rihana/swagger/basePath")
	...
	public void init() {
		...
		config.setTitle("RIHANA");
		config.setDescription("Radiological Image and History Acquisition for Neurocomputing Analysis - Backend");
