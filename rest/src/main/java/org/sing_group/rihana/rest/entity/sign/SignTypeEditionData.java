...
@XmlRootElement(name = "Sign-type-edition-data", namespace = "http://entity.resource.rest.rihana.sing-group.org")
@XmlAccessorType(XmlAccessType.FIELD)
@ApiModel(value = "Sign-type-edition-data", description = "Information of a sign type for edition.")
public class SignTypeEditionData implements Serializable {
